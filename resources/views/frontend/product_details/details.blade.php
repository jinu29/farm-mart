...
@if ($detailedProduct->auction_product)
    <div class="row d-flex align-items-start mb-3">
        <div class="col-3">
            <div class="details">
                <h5>{{ translate('Auction Will End:') }}</h5>
            </div>
        </div>
        <div class="col-9">
        ...
        <div class="col-9">
            <div class="details">
                ...
                @if ($detailedProduct->unit != null)
                    <p>/{{ $detailedProduct->getTranslation('unit') }}</p>
                @endif
            </div>
        </div>
    </div>
    @if (Auth::check() && Auth::user()->product_bids->where('product_id', $detailedProduct->id)->first() != null)
        <div class="row">
            <div class="col-3">
                <div class="details">
                    <h5>{{ translate('My Bidded Amount') }}</h5>
                </div>
            </div>
            <div class="col-9">
                <div class="product-detail">
                    <p>{{ single_price(Auth::user()->product_bids->where('product_id', $detailedProduct->id)->first()->amount) }}</p>
                </div>
            </div>
        </div>
    @endif
    ...
    <div class="row d-flex align-items-start mb-3">
        <div class="col-3">
            <div class="details">
                <h5>{{ translate('Highest Bid') }}</h5>
            </div>
        </div>
        <div class="col-9">
            <div class="details">
                @if ($highest_bid != null)
                    <p>{{ single_price($highest_bid) }}</p>
                @endif
            </div>
        </div>
    </div>
