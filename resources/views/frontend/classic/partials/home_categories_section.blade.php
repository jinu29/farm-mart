    ...
    <div class="container">
        <div class="row gutters-16">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
                <h4 class="fs-25 fw-700">{{ $category_name }}</h4>
                <div class="aiz-carousel arrow-x-0 arrow-inactive-none" data-items="5"
                    data-xxl-items="5" data-xl-items="5" data-lg-items="3" data-md-items="2" data-sm-items="2"
                    data-xs-items="2" data-arrows='true' data-infinite='false'>
                    @foreach (get_cached_products($category->id) as $product_key => $product)
                    <div
                        class="carousel-box position-relative has-transition @if ($product_key == 0) @endif hover-img-scale">
