                                ...
                                <div class="pt-3">
                                    <div class="">
                                        <form id="reg-form" class="form-default" role="form"
                                            ...
                                            <!-- Country -->
                                            <div class="row" class='form-group pt-2'>
                                                <div class="col-md-2">
                                            ...
                                            @if (get_setting('google_map') == 1)
                                                ...
                                                <div class="row">
                                                    ...
                                                    <!-- <div id="map"></div> -->
                                                    <ul id="geoData">
                                                        <li style="display: none;">Full Address: <span
                                                                id="location"></span></li>
                                                        <li style="display: none;">Postal Code: <span
                                                                id="postal_code"></span></li>
                                                        <li style="display: none;">Country: <span id="country"></span>
                                                        </li>
                                                        <li style="display: none;" >Latitude: <span id="lat" class='fs-12 fw-700 text-soft-dark'></span>
                                                        </li>
                                                        <li style="display: none;">Longitude: <span id="lon" class='fs-12 fw-700 text-soft-dark'></span>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <!-- Longitude -->
                                                <div class="row">
                                                    <div class="col-md-2" id="">
                                                        <label
                                                            for="exampleInputuname" class='fs-12 fw-700 text-soft-dark'>{{ translate('Longitude') }}</label>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-2" id="">
                                                        <label for="exampleInputuname" class='fs-12 fw-700 text-soft-dark'>{{ translate('Latitude') }}</label>
                                                    </div>
                                                    <div class="col-md-10" id="">
                                                        <input type="text" class="form-control mb-3 rounded-0"
                                                            id="latitude" name="latitude" readonly="" class='fs-12 fw-700 text-soft-dark'>
                                                    </div>
                                                </div>
                                            @endif
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control mb-3 rounded-0"
                                                        placeholder="{{ translate('+880') }}" name="phone"
                                                        value="" required>
                                                </div>
                                            </div>
                                            <!-- Recaptcha -->
