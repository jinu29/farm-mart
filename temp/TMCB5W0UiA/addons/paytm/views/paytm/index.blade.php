...
@section('content')
    <div class="row">
                ...
                <div class="card-body text-center">
                    <div class="clearfix">
                        ...
                        <label class="aiz-switch aiz-switch-success mb-0 float-right">
                            <input type="checkbox" onchange="updateSettings(this, 'paytm_payment')" <?php if (\App\Models\BusinessSetting::where('type', 'paytm_payment')->first()->value == 1) {
                                echo 'checked';
                            } ?>>
            ...
            <div class="card">
                ...
                <div class="card-body text-center">
                    <div class="clearfix">
                        ...
                        <label class="aiz-switch aiz-switch-success mb-0 float-right">
                            <input type="checkbox" onchange="updateSettings(this, 'toyyibpay_payment')" <?php if (\App\Models\BusinessSetting::where('type', 'toyyibpay_payment')->first()->value == 1) {
                                echo 'checked';
                            } ?>>
                            <span class="slider round"></span>
                        </label>
            ...
            <div class="card">
                ...
                <div class="card-body text-center">
                    <div class="clearfix">
                        ...
                        <label class="aiz-switch aiz-switch-success mb-0 float-right">
                            <input type="checkbox" onchange="updateSettings(this, 'myfatoorah')" <?php if (get_setting('myfatoorah') == 1) {
                                echo 'checked';
                            } ?>>
                            <span class="slider round"></span>
                        </label>
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="mb-0 h6 text-center">{{ translate('Khalti Activation') }}</h3>
                </div>
                <div class="card-body text-center">
                    <div class="clearfix">
                        <img class="float-left" src="{{ static_asset('assets/img/cards/khalti.png') }}" height="30">
                        <label class="aiz-switch aiz-switch-success mb-0 float-right">
                            <input type="checkbox" onchange="updateSettings(this, 'khalti_payment')" <?php if (get_setting('khalti_payment') == 1) {
                                echo 'checked';
                            } ?>>
                            <span class="slider round"></span>
                        </label>
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="mb-0 h6 text-center">{{ translate('Phonepe Activation') }}</h3>
                </div>
                <div class="card-body text-center">
                    <div class="clearfix">
                        <img class="float-left" src="{{ static_asset('assets/img/cards/phonepe.png') }}" height="30">
                        <label class="aiz-switch aiz-switch-success mb-0 float-right">
                            <input type="checkbox" onchange="updateSettings(this, 'phonepe_payment')" <?php if (get_setting('phonepe_payment') == 1) {
                                echo 'checked';
                            } ?>>
                            <span class="slider round"></span>
                        </label>
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6">{{ translate('Khalti') }}</h5>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                        @csrf
